...
<script>
import { fetchList, createHospital, updateHospital, deleteHospital } from '@/api/side_navigation/data_hospital/data_hospital'
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            items: [
              { 'id': 1, 'number': 'YW_abc12345678', 'name': '教授', 'num': 20, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 2, 'number': 'YW_abc12345678', 'name': '副教授', 'num': 20, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 3, 'number': 'YW_abc12345678', 'name': '博士研究生', 'num': 30, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 4, 'number': 'YW_abc12345678', 'name': '博士研究生2', 'num': 30, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' }
            ]
          }
