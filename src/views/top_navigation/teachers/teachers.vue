...
<script>
import { fetchList, updateTeachers, updatePic } from '@/api/top_navigation/teachers/teachers'
...
const TypeOptions = [
  { key: 1, display_name: '教授' },
  { key: 2, display_name: '副教授' },
  { key: 3, display_name: '博士研究生' },
  { key: 4, display_name: '硕士研究生' }
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            items: [
              { 'id': 1, 'number': 'YW_abc12345678', 'type': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'num': 20 },
              { 'id': 2, 'number': 'YW_abc12345678', 'type': 2, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'num': 10 },
              { 'id': 3, 'number': 'YW_abc12345678', 'type': 3, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'num': 5 },
              { 'id': 4, 'number': 'YW_abc12345678', 'type': 4, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'num': 10 }
            ]
          }
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          tempData.timestamp = +new Date(tempData.timestamp) // change Thu Nov 30 2017 16:41:05 GMT+0800 (CST) to 1512031311464
          updateTeachers(tempData, tempData.id).then(() => {
            this.$notify({
              title: 'Success',
              message: 'Update Successfully',
              type: 'success',
