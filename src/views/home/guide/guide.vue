<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="this.listQuery.title == undefined" align="center" label="Drag" width="80">
        <template slot-scope="{}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 80%; margin-left:50px;">
        ...
        <el-form-item label="输入内容" prop="content">
          <textarea v-model="temp.content" :height="300" />
        </el-form-item>
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            items: [
              { 'id': 1, 'number': 'YW_abc12345678', 'type': 1, 'title': '全景地图', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 2, 'number': 'YW_abc12345678', 'type': 2, 'title': '全景地图', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 3, 'number': 'YW_abc12345678', 'type': 3, 'title': '护理学院教学楼', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' },
              { 'id': 4, 'number': 'YW_abc12345678', 'type': 4, 'title': '健身房', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'content': '内容' }
            ]
          }
