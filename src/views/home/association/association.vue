<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="标题" min-width="90">
        <template slot-scope="{row}">
...
import { fetchList, createAssociation, updateAssociation, deleteAssociation } from '@/api/home/association/association'
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            items: [
              { 'id': 1, 'number': 'YW_abc12345678', 'title': '社团管理', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'intro': '简介' },
              { 'id': 2, 'number': 'YW_abc12345678', 'title': '社团管理', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'intro': '简介' },
              { 'id': 3, 'number': 'YW_abc12345678', 'title': '社团管理', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'intro': '简介' },
              { 'id': 4, 'number': 'YW_abc12345678', 'title': '社团管理', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'intro': '简介' }
            ]
          }
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        ...
        //   this.temp.author = 'vue-element-admin'
          ...
          createAssociation(this.temp).then(() => {
    ...
    updatePicData() {
      ...
      this.$refs['dataFormPic'].validate((valid) => {
        if (valid) {
          ...
          updateAssociation(tempData, tempData.id).then(() => {
            this.$notify({
              title: 'Success',
              message: 'Update Successfully',
              type: 'success',
