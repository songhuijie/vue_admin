<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="海报" min-width="150px" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchList, updateBriefingPoster } from '@/api/home/briefing/briefing_poster'
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          updateBriefingPoster(tempData, tempData.id).then(() => {
            this.$notify({
              title: 'Success',
              message: 'Update Successfully',
              type: 'success',
