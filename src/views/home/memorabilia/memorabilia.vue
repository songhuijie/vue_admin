...
<script>
import { fetchList, updateMemorabilia, deleteMemorabilia } from '@/api/home/memorabilia/memorabilia'
  ...
  methods: {
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            data: [
              { 'id': 1, 'number': 'YW_abc12345678', 'type': 1, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '大事件标题', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 2, 'number': 'YW_abc12345678', 'type': 2, 'enable': 0, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '大事件标题2', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 3, 'number': 'YW_abc12345678', 'type': 3, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '大事件标题3', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 4, 'number': 'YW_abc12345678', 'type': 4, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '大事件标题4', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 5, 'number': 'YW_abc12345678', 'type': 5, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '大事件标题4', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' }
            ]
          },
          extra: {
            enable_count: 4
    ...
    handleModifyStatus(row, status) {
      if (this.enable_count >= 4 && status === 'enable') {
        ...
        updateMemorabilia(row, row.id).then(() => {
