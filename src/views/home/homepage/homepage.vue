...
<script>
import { fetchList, updateHomepage, deleteHomepage, sort } from '@/api/home/homepage/homepage'
...
export default {
  ...
  methods: {
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            data: [
              { 'id': 1, 'number': 'YW_abc12345678', 'type': 1, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '首页标题', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 2, 'number': 'YW_abc12345678', 'type': 2, 'enable': 0, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '首页标题2', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 3, 'number': 'YW_abc12345678', 'type': 3, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '首页标题3', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 4, 'number': 'YW_abc12345678', 'type': 2, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '首页标题4', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' },
              { 'id': 5, 'number': 'YW_abc12345678', 'type': 3, 'enable': 1, 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'title': '首页标题5', 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png' }
            ]
          },
          extra: {
          }
    ...
    setSort() {
      ...
      this.sortable = Sortable.create(el, {
        ...
        onEnd: evt => {
          ...
          sort(data).then(() => function() { // eslint-disable-line no-unused-var
            console.log('1')
          })
        }
      })
    ...
    handleModifyStatus(row, status) {
      ...
      updateHomepage(row, row.id).then(() => {
