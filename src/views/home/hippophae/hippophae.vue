<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.is_relation_list" placeholder="关联首页" style="width: 140px" class="filter-item" @change="handleFilter">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="400" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button v-if="row.is_relation_list == 0 " type="primary" size="mini" @click="handleChangeStatus(row,1,1)">
            关联列表页
          </el-button>
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 80%; margin-left:50px;">
        ...
        <el-form-item label="类型" prop="type">
          <el-select v-model="temp.type" class="filter-item" placeholder="Please select">
            <el-option v-for="item in TypesOptions" :key="item.key" :label="item.display_name" :value="item.key" />
          </el-select>
        </el-form-item>
...
const TypeOptions = [
  { key: '', display_name: '全部' },
  { key: 1, display_name: '人物' },
  { key: 0, display_name: '非人物' }
]
const TypesOptions = [
  { key: 0, display_name: '非人物' },
  { key: 1, display_name: '人物' }
      ...
      fetchList(this.listQuery).then(response => {
        response = this.$notify({
          ...
          data: {
            total: 3,
            items: [
              { 'id': 1, 'number': 'YW_abc12345678', 'title': '沙棘精神1', 'type': 0, 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'is_relation_list': 0, 'is_relation_rotation': 0, 'is_relation_memorabilia': 0, 'content': '内容' },
              { 'id': 2, 'number': 'YW_abc12345678', 'title': '沙棘精神2', 'type': 1, 'cover': 'https://axure-file.lanhuapp.com/75bb826c-df35-4a34-b9a5-86b4cff4543c__28e3bf0b1943ba0890f45e053338de22.png', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'is_relation_list': 1, 'is_relation_rotation': 1, 'is_relation_memorabilia': 1, 'content': '内容' },
              { 'id': 3, 'number': 'YW_abc12345678', 'title': '沙棘精神3', 'type': 1, 'cover': '', 'created_at': '2020-04-30 11:11:11', 'updated_at': '2020-04-30 11:11:11', 'is_relation_list': 0, 'is_relation_rotation': 1, 'is_relation_memorabilia': 1, 'content': '内容' }
            ]
