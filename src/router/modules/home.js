...
const homeRouter = {
  ...
  children: [
    ...
    },
    {
      ...
      name: 'homepage',
      meta: { title: '首页管理', icon: 'list' }
    },
    {
      path: 'list/list',
      component: () => import('@/views/home/list/list'),
      name: 'list',
      meta: { title: '列表页管理', icon: 'list' }
    },
    {
      path: 'focus_news/focus_news',
      component: () => import('@/views/home/focus_news/focus_news'),
      name: 'focus_news',
      meta: { title: '要闻管理', icon: 'list' }
    },
    {
      path: 'briefing/briefing',
      component: () => import('@/views/home/briefing/briefing'),
      name: '',
      meta: { title: '简报管理', icon: 'list' },
      children: [
        {
          path: 'briefing/briefing',
          component: () => import('@/views/home/briefing/briefing'),
